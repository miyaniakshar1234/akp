...
- 🔎 **KMP Pattern Matching Visualizer**: Knuth-Morris-Pratt substring search with Longest Prefix Suffix (LPS/$\pi$) array computation and step-by-step match comparisons (`akp_kmp_search`).
